...
class ApplicationLoadBalancer extends pulumi.ComponentResource {
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["defaultSecurityGroup"] = args ? (args.defaultSecurityGroup ? types_1.input.awsx.defaultSecurityGroupArgsProvideDefaults(args.defaultSecurityGroup) : undefined) : undefined;
