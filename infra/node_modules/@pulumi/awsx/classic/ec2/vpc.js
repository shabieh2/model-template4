...
class VpcData {
    ...
    constructor(name, parent, args, opts) {
        ...
        if (isExistingVpcArgs(args)) {
            ...
            if (args.internetGatewayId) {
                ...
                this.internetGateway = new internetGateway_1.InternetGateway(igName, parent, {
            ...
            if (args.natGatewayIds) {
                for (let i = 0, n = args.natGatewayIds.length; i < n; i++) {
                    ...
                    this.natGateways.push(new natGateway_1.NatGateway(natName, parent, {
    ...
    partition(name, cidrBlock, availabilityZones, numberOfNatGateways, assignGeneratedIpv6CidrBlock, subnetArgs, opts) {
        ...
        for (const desc of subnets) {
            ...
            const subnet = new subnet_1.Subnet(desc.subnetName, this.parent, Object.assign(Object.assign({}, desc.args), { availabilityZone,
...
class Vpc extends pulumi.ComponentResource {
    ...
    /** @internal */
    initializeExistingVpcArgs(name, args, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            return new VpcData(name, this, args, opts);
        });
    }
    /** @internal */
    initializeExistingVpcIdArgs(name, args, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            return new VpcData(name, this, args, opts);
        });
    }
    /** @internal */
    initializeDefaultVpcArgs(name, args, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const vpcId = yield args.vpcId;
            const provider = args.provider;
            const getSubnetsResult = yield aws.ec2.getSubnetIds({ vpcId }, { provider, async: true });
    ...
    /** @internal */
    initializeVpcArgs(name, args, opts) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const provider = Vpc.getProvider(opts);
            const availabilityZones = yield getAvailabilityZones(opts.parent, provider, (_a = args.requestedAvailabilityZones) !== null && _a !== void 0 ? _a : args.numberOfAvailabilityZones);
...
function getAvailabilityZones(parent, provider, requestedZones = 2) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield aws.getAvailabilityZones(/*args:*/ undefined, { provider, async: true });
