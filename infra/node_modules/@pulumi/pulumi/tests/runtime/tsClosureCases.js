...
const deploymentOnlyModule = __importStar(require("./deploymentOnlyModule"));
/** @internal */
exports.exportedValue = 42;
...
`,
    ...
    cases.push({
        ...
        // @ts-ignore: this is just test code.
        func: () => __awaiter(void 0, void 0, void 0, function* () { console.log(this); }),
        expectText: `exports.handler = __f0;
${awaiterCode}
function __f0() {
  return (function() {
...
`,
    ...
    cases.push({
        ...
        func: () => { let x = eval("undefined + null + NaN + Infinity + __filename"); require("os"); },
        expectText: `exports.handler = __f0;
...
`,
    ...
    {
        const v = {
            d1: output_1.output(4),
            d2: output_1.output("str"),
            d3: output_1.output(undefined),
            d4: output_1.output({ a: 1, b: true }),
        };
        cases.push({
...
`,
    ...
    {
        const x = { a: 1, b: true };
        const o1 = output_1.output(x);
        const o2 = output_1.output(x);
        const y = { o1, o2 };
        const o3 = output_1.output(y);
        const o4 = output_1.output(y);
        const o5 = { o3, o4 };
        o5.a = output_1.output(y);
        o5.b = y;
        o5.c = [output_1.output(y)];
        o5.d = [y];
        o5.a_1 = o5.a;
        o5.b_1 = o5.b;
        o5.c_1 = o5.c;
        o5.d_1 = o5.d;
        const o6 = output_1.output(o5);
...
`,
    ...
    }
    {
        ...
        class B extends A {
            ...
            method(n) { return 1 + super.method(n + 1); }
        }
        class C extends B {
            constructor(n) {
                super(n * 2);
            ...
            method(n) { return 2 * super.method(n * 2); }
        }
        cases.push({
...
`
    ...
    }
    {
        ...
        class A {
            ...
            static method(x) { return x; }
            static [sym](x) { return x * x; }
        }
        class B extends A {
            static method(n) { return 1 + super.method(n + 1); }
            // @ts-ignore
            static [sym](x) { return x * super[sym](x + 1); }
            constructor(n) {
                super(n + 1);
                console.log("BConstructor");
            }
...
`,
    ...
    {
        const table1 = { primaryKey: 1, insert: () => { }, scan: () => { } };
        function testScanReturnsAllValues() {
            return __awaiter(this, void 0, void 0, function* () {
...
`,
    ...
    {
        const awaiter1 = function (thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))(function (resolve, reject) {
        ...
        const awaiter2 = function (thisArg, _arguments, P, generator) {
            return new (P || (P = Promise))(function (resolve, reject) {
                function fulfilled(value) { try {
                    step(generator.next(value));
                }
...
`,
    ...
    }
    {
        ...
        cases.push({
            ...
            func: function () { require("typescript"); foo(); if (true) {
                require("os");
            } },
            expectText: `exports.handler = __f0;
...
`,
    ...
    cases.push({
        ...
        // @ts-ignore
        func: ({ whatever }) => __awaiter(void 0, void 0, void 0, function* () { }),
        expectText: `exports.handler = __f0;
...
`,
    ...
    {
        // @ts-ignore
        const getSchemaValidator = () => mockpackage_1.z.object({
            message: mockpackage_1.z.string(),
        });
        function reproHandler(input) {
            return __awaiter(this, void 0, void 0, function* () {
...
`,
    ...
    function serializeFunction(test) {
        return __awaiter(this, void 0, void 0, function* () {
            if (test.func) {
                return yield index_1.runtime.serializeFunction(test.func, {
                    allowSecrets: test.allowSecrets,
                });
            }
            else if (test.factoryFunc) {
                return yield index_1.runtime.serializeFunction(test.factoryFunc, {
                    allowSecrets: test.allowSecrets,
 ...
 */
function compareTextWithWildcards(expected, actual) {
    const wildcard = "(...)";
    expected = expected.replace(constants_1.platformIndependentEOL, '\n');
    actual = actual.replace(constants_1.platformIndependentEOL, '\n');
...
//# sourceMappingURL=tsClosureCases.js.map