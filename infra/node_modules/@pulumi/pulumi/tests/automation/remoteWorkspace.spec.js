...
describe("RemoteWorkspace", () => {
    describe("selectStack", () => {
        describe("throws appropriate errors", () => testErrors(automation_1.RemoteWorkspace.selectStack));
    });
    describe("createStack", () => {
        describe("throws appropriate errors", () => testErrors(automation_1.RemoteWorkspace.createStack));
        it(`runs through the stack lifecycle`, function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield testLifecycle(automation_1.RemoteWorkspace.createStack);
            });
        });
    });
    describe("createOrSelectStack", () => {
        describe("throws appropriate errors", () => testErrors(automation_1.RemoteWorkspace.createOrSelectStack));
        it(`runs through the stack lifecycle`, function () {
            return __awaiter(this, void 0, void 0, function* () {
                // This test requires the service with access to Pulumi Deployments.
                // Set PULUMI_ACCESS_TOKEN to an access token with access to Pulumi Deployments
                ...
                yield testLifecycle(automation_1.RemoteWorkspace.createOrSelectStack);
            });
        });
    });
});
function testErrors(fn) {
...
function testLifecycle(fn) {
    return __awaiter(this, void 0, void 0, function* () {
        const stackName = automation_1.fullyQualifiedStackName(util_1.getTestOrg(), "go_remote_proj", `int_test${util_1.getTestSuffix()}`);
        const stack = yield fn({
            stackName,
            url: testRepo,
        ...
        yield (yield automation_1.LocalWorkspace.create({})).removeStack(stackName);
    });
}
describe("isFullyQualifiedStackName", () => {
    ...
    tests.forEach(test => {
        it(`${test.name}`, () => {
            const actual = automation_1.isFullyQualifiedStackName(test.input);
            assert_1.default.strictEqual(actual, test.expected);
        });
    });
});
//# sourceMappingURL=remoteWorkspace.spec.js.map