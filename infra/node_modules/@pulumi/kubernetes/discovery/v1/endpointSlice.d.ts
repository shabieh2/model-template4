 ...
 */
export declare class EndpointSlice extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EndpointSlice;
    /**
     ...
     */
    readonly endpoints: pulumi.Output<outputs.discovery.v1.Endpoint[]>;
    /**
     ...
     */
    readonly ports: pulumi.Output<outputs.discovery.v1.EndpointPort[]>;
    /**
