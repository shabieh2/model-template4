...
class PriorityLevelConfiguration extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:PriorityLevelConfiguration" }, { type: "kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:PriorityLevelConfiguration" }, { type: "kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfiguration" }] };
...
/** @internal */
PriorityLevelConfiguration.__pulumiType = 'kubernetes:flowcontrol.apiserver.k8s.io/v1beta3:PriorityLevelConfiguration';
