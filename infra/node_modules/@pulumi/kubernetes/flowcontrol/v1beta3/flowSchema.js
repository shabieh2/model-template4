...
class FlowSchema extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:flowcontrol.apiserver.k8s.io/v1alpha1:FlowSchema" }, { type: "kubernetes:flowcontrol.apiserver.k8s.io/v1beta1:FlowSchema" }, { type: "kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchema" }] };
...
/** @internal */
FlowSchema.__pulumiType = 'kubernetes:flowcontrol.apiserver.k8s.io/v1beta3:FlowSchema';
