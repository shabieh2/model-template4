 ...
 */
export declare class ValidatingAdmissionPolicyList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ValidatingAdmissionPolicyList;
    /**
     ...
     */
    static isInstance(obj: any): obj is ValidatingAdmissionPolicyList;
    /**
     ...
     */
    readonly items: pulumi.Output<outputs.admissionregistration.v1alpha1.ValidatingAdmissionPolicy[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    readonly kind: pulumi.Output<"ValidatingAdmissionPolicyList">;
    /**
