 ...
 */
export declare class ValidatingAdmissionPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ValidatingAdmissionPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is ValidatingAdmissionPolicy;
    /**
