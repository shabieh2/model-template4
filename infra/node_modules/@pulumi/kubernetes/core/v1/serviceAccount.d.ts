...
export declare class ServiceAccount extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceAccount;
    /**
     ...
     */
    readonly imagePullSecrets: pulumi.Output<outputs.core.v1.LocalObjectReference[]>;
    /**
