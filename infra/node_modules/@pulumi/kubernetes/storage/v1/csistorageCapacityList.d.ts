 ...
 */
export declare class CSIStorageCapacityList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CSIStorageCapacityList;
    /**
     * Returns true if the given object is an instance of CSIStorageCapacityList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CSIStorageCapacityList;
    /**
     ...
     */
    readonly kind: pulumi.Output<"CSIStorageCapacityList">;
    /**
     ...
     */
    constructor(name: string, args?: CSIStorageCapacityListArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * The set of arguments for constructing a CSIStorageCapacityList resource.
 */
export interface CSIStorageCapacityListArgs {
    /**
     * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
     */
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"CSIStorageCapacityList">;
    /**
     * Standard list metadata More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
