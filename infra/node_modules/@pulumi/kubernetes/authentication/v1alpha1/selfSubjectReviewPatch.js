...
class SelfSubjectReviewPatch extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["apiVersion"] = "authentication.k8s.io/v1alpha1";
...
/** @internal */
SelfSubjectReviewPatch.__pulumiType = 'kubernetes:authentication.k8s.io/v1alpha1:SelfSubjectReviewPatch';
