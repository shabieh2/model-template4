 ...
 */
export declare class TokenReview extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TokenReview;
    /**
     * Returns true if the given object is an instance of TokenReview.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TokenReview;
    /**
     ...
     */
    readonly spec: pulumi.Output<outputs.authentication.v1beta1.TokenReviewSpec>;
    /**
     * Status is filled in by the server and indicates whether the request can be authenticated.
     */
    readonly status: pulumi.Output<outputs.authentication.v1beta1.TokenReviewStatus>;
    /**
...
export interface TokenReviewArgs {
     ...
     * Spec holds information about the request being evaluated
     */
    spec: pulumi.Input<inputs.authentication.v1beta1.TokenReviewSpec>;
}
