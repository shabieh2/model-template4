 ...
 */
export declare class TokenRequest extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TokenRequest;
    /**
     * Returns true if the given object is an instance of TokenRequest.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TokenRequest;
    /**
     ...
     */
    readonly spec: pulumi.Output<outputs.authentication.v1.TokenRequestSpec>;
    /**
     * Status is filled in by the server and indicates whether the token can be authenticated.
     */
    readonly status: pulumi.Output<outputs.authentication.v1.TokenRequestStatus>;
    /**
