...
export declare class StatefulSet extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StatefulSet;
    /**
     * Returns true if the given object is an instance of StatefulSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StatefulSet;
    /**
     ...
     */
    readonly spec: pulumi.Output<outputs.apps.v1.StatefulSetSpec>;
    /**
     * Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
     */
    readonly status: pulumi.Output<outputs.apps.v1.StatefulSetStatus>;
    /**
