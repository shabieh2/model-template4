...
exports.SubjectAccessReviewPatch = void 0;
 ...
 */
class SubjectAccessReviewPatch extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new SubjectAccessReviewPatch(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:authorization.k8s.io/v1beta1:SubjectAccessReviewPatch" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(SubjectAccessReviewPatch.__pulumiType, name, resourceInputs, opts);
    }
}
exports.SubjectAccessReviewPatch = SubjectAccessReviewPatch;
/** @internal */
SubjectAccessReviewPatch.__pulumiType = 'kubernetes:authorization.k8s.io/v1:SubjectAccessReviewPatch';
//# sourceMappingURL=subjectAccessReviewPatch.js.map