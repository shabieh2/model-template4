...
export declare class SelfSubjectRulesReview extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputs.authorization.v1.SelfSubjectRulesReviewSpec>;
    /**
     * Status is filled in by the server and indicates the set of actions a user can perform.
     */
    readonly status: pulumi.Output<outputs.authorization.v1.SubjectRulesReviewStatus>;
    /**
...
export interface SelfSubjectRulesReviewArgs {
     ...
     * Spec holds information about the request being evaluated.
     */
    spec: pulumi.Input<inputs.authorization.v1.SelfSubjectRulesReviewSpec>;
}
