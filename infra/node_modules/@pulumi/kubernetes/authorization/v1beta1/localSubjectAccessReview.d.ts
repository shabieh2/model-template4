 ...
 */
export declare class LocalSubjectAccessReview extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LocalSubjectAccessReview;
    /**
     * Returns true if the given object is an instance of LocalSubjectAccessReview.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LocalSubjectAccessReview;
    /**
     ...
     */
    readonly spec: pulumi.Output<outputs.authorization.v1beta1.SubjectAccessReviewSpec>;
    /**
