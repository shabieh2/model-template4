 ...
 */
export declare class SelfSubjectAccessReview extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SelfSubjectAccessReview;
    /**
     * Returns true if the given object is an instance of SelfSubjectAccessReview.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SelfSubjectAccessReview;
    /**
     ...
     */
    readonly spec: pulumi.Output<outputs.authorization.v1beta1.SelfSubjectAccessReviewSpec>;
    /**
     * Status is filled in by the server and indicates whether the request is allowed or not
     */
    readonly status: pulumi.Output<outputs.authorization.v1beta1.SubjectAccessReviewStatus>;
    /**
