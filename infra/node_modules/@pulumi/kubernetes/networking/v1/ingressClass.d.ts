 ...
 */
export declare class IngressClass extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IngressClass;
    /**
     * Returns true if the given object is an instance of IngressClass.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IngressClass;
    /**
     ...
     */
    readonly spec: pulumi.Output<outputs.networking.v1.IngressClassSpec>;
    /**
