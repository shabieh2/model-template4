...
class Provider extends pulumi.ProviderResource {
    ...
    constructor(name, args, opts) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["suppressDeprecationWarnings"] = pulumi.output((_f = (args ? args.suppressDeprecationWarnings : undefined)) !== null && _f !== void 0 ? _f : utilities.getEnvBoolean("PULUMI_K8S_SUPPRESS_DEPRECATION_WARNINGS")).apply(JSON.stringify);
            resourceInputs["suppressHelmHookWarnings"] = pulumi.output((_g = (args ? args.suppressHelmHookWarnings : undefined)) !== null && _g !== void 0 ? _g : utilities.getEnvBoolean("PULUMI_K8S_SUPPRESS_HELM_HOOK_WARNINGS")).apply(JSON.stringify);
        }
