...
exports.Vocabulary = exports.UserHierarchyStructure = exports.UserHierarchyGroup = exports.User = exports.SecurityProfile = exports.RoutingProfile = exports.QuickConnect = exports.Queue = exports.PhoneNumber = exports.LambdaFunctionAssociation = exports.InstanceStorageConfig = exports.Instance = exports.HoursOfOperation = exports.getUserHierarchyStructureOutput = exports.getUserHierarchyStructure = exports.getUserHierarchyGroupOutput = exports.getUserHierarchyGroup = exports.getSecurityProfileOutput = exports.getSecurityProfile = exports.getRoutingProfileOutput = exports.getRoutingProfile = exports.getQuickConnectOutput = exports.getQuickConnect = exports.getQueueOutput = exports.getQueue = exports.getPromptOutput = exports.getPrompt = exports.getLambdaFunctionAssociationOutput = exports.getLambdaFunctionAssociation = exports.getInstanceStorageConfigOutput = exports.getInstanceStorageConfig = exports.getInstanceOutput = exports.getInstance = exports.getHoursOfOperationOutput = exports.getHoursOfOperation = exports.getContactFlowModuleOutput = exports.getContactFlowModule = exports.getContactFlowOutput = exports.getContactFlow = exports.getBotAssociationOutput = exports.getBotAssociation = exports.ContactFlowModule = exports.ContactFlow = exports.BotAssociation = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.BotAssociation = null;
utilities.lazyLoad(exports, ["BotAssociation"], () => require("./botAssociation"));
exports.ContactFlow = null;
utilities.lazyLoad(exports, ["ContactFlow"], () => require("./contactFlow"));
exports.ContactFlowModule = null;
utilities.lazyLoad(exports, ["ContactFlowModule"], () => require("./contactFlowModule"));
exports.getBotAssociation = null;
exports.getBotAssociationOutput = null;
utilities.lazyLoad(exports, ["getBotAssociation", "getBotAssociationOutput"], () => require("./getBotAssociation"));
exports.getContactFlow = null;
exports.getContactFlowOutput = null;
utilities.lazyLoad(exports, ["getContactFlow", "getContactFlowOutput"], () => require("./getContactFlow"));
exports.getContactFlowModule = null;
exports.getContactFlowModuleOutput = null;
utilities.lazyLoad(exports, ["getContactFlowModule", "getContactFlowModuleOutput"], () => require("./getContactFlowModule"));
exports.getHoursOfOperation = null;
exports.getHoursOfOperationOutput = null;
...
exports.getInstanceStorageConfig = null;
exports.getInstanceStorageConfigOutput = null;
utilities.lazyLoad(exports, ["getInstanceStorageConfig", "getInstanceStorageConfigOutput"], () => require("./getInstanceStorageConfig"));
exports.getLambdaFunctionAssociation = null;
exports.getLambdaFunctionAssociationOutput = null;
...
exports.getQuickConnect = null;
exports.getQuickConnectOutput = null;
utilities.lazyLoad(exports, ["getQuickConnect", "getQuickConnectOutput"], () => require("./getQuickConnect"));
exports.getRoutingProfile = null;
exports.getRoutingProfileOutput = null;
...
exports.getUserHierarchyGroup = null;
exports.getUserHierarchyGroupOutput = null;
utilities.lazyLoad(exports, ["getUserHierarchyGroup", "getUserHierarchyGroupOutput"], () => require("./getUserHierarchyGroup"));
exports.getUserHierarchyStructure = null;
exports.getUserHierarchyStructureOutput = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws:connect/botAssociation:BotAssociation":
                return new exports.BotAssociation(name, undefined, { urn });
            case "aws:connect/contactFlow:ContactFlow":
                return new exports.ContactFlow(name, undefined, { urn });
            ...
            case "aws:connect/hoursOfOperation:HoursOfOperation":
                return new exports.HoursOfOperation(name, undefined, { urn });
            case "aws:connect/instance:Instance":
                return new exports.Instance(name, undefined, { urn });
            case "aws:connect/instanceStorageConfig:InstanceStorageConfig":
                return new exports.InstanceStorageConfig(name, undefined, { urn });
            case "aws:connect/lambdaFunctionAssociation:LambdaFunctionAssociation":
                return new exports.LambdaFunctionAssociation(name, undefined, { urn });
            ...
            case "aws:connect/quickConnect:QuickConnect":
                return new exports.QuickConnect(name, undefined, { urn });
            case "aws:connect/routingProfile:RoutingProfile":
                return new exports.RoutingProfile(name, undefined, { urn });
            ...
            case "aws:connect/userHierarchyGroup:UserHierarchyGroup":
                return new exports.UserHierarchyGroup(name, undefined, { urn });
            case "aws:connect/userHierarchyStructure:UserHierarchyStructure":
                return new exports.UserHierarchyStructure(name, undefined, { urn });
