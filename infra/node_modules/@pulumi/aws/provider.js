...
class Provider extends pulumi.ProviderResource {
    ...
    constructor(name, args, opts) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["region"] = (_a = (args ? args.region : undefined)) !== null && _a !== void 0 ? _a : utilities.getEnv("AWS_REGION", "AWS_DEFAULT_REGION");
            ...
            resourceInputs["skipCredentialsValidation"] = pulumi.output((_b = (args ? args.skipCredentialsValidation : undefined)) !== null && _b !== void 0 ? _b : false).apply(JSON.stringify);
            resourceInputs["skipGetEc2Platforms"] = pulumi.output(args ? args.skipGetEc2Platforms : undefined).apply(JSON.stringify);
            resourceInputs["skipMetadataApiCheck"] = pulumi.output((_c = (args ? args.skipMetadataApiCheck : undefined)) !== null && _c !== void 0 ? _c : true).apply(JSON.stringify);
            resourceInputs["skipRegionValidation"] = pulumi.output((_d = (args ? args.skipRegionValidation : undefined)) !== null && _d !== void 0 ? _d : true).apply(JSON.stringify);
